...
namespace IronRuby.Hpricot.FastXs {
    public class Entities {
        ...
        /// </summary>
        private static readonly Entities _xmlEntities;

        /// <summary>
        /// The set of entities supported by standard HTML 3.2.
        /// </summary>
        private static readonly Entities _html32Entities;
        ...
        private static readonly String[,] APOS_ARRAY = {
            {"apos", "39"},     // XML apostrophe
        };

        // package scoped for testing
        private static readonly String[,] ISO8859_1_ARRAY = {
        ...
        // package scoped for testing
        private static readonly String[,] HTML40_ARRAY = {
            // <!-- Latin Extended-B -->
        ...
        static Entities() {
            ...
            _xmlEntities.AddEntities(APOS_ARRAY);

            _html32Entities = new Entities();
            _html32Entities.AddEntities(BASIC_ARRAY);
            _html32Entities.AddEntities(ISO8859_1_ARRAY);

            _html40Entities = new Entities();
        ...
        /// </summary>
        /// <param name="entityArray">array of entities to be added</param>
        public void AddEntities(String[,] entityArray) {
            for (int i = 0; i < entityArray.Length / 2; ++i) {
                AddEntity(entityArray[i, 0], Int32.Parse(entityArray[i, 1]));
            }
        }
        ...
        /// <param name="value">vaule of the entity</param>
        public void AddEntity(String/*!*/ name, Int32 value) {
            _map.Add(name, value);
        }
        ...
        public String EntityName(Int32 value) {
        ...
        /// </summary>
        /// <param name="name">entity value associated with the specified name</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="str">The <code>String</code> to escape.</param>
        /// <returns>A new escaped <code>String</code>.</returns>
        public String Escape(String/*!*/ str) {
            StringBuilder stringBuilder = CreateStringBuilder(str);
            try {
                ...
                // throw IOExceptions.
                throw new ApplicationException("Caught", e);
            }
        ...
        /// <summary>
        ///  Escapes the characters in the <code>String</code> passed and 
        ///  writes the result to the <code>StringBuilder</code> passed.
        /// </summary>
        /// <param name="builder">
        /// The <code>StringBuilder</code> to write the results of the 
        /// escaping to. Assumed to be a non-null value.</param>
        /// <param name="str">
        /// The <code>String</code> to escape. Assumed to be a non-null value.
        /// </param>
        public void Escape(StringBuilder/*!*/ builder, String/*!*/ str) {
            int len = str.Length;
            for (int i = 0; i < len; i++) {
                char c = str[i];
                ...
                if (entityName == null) {
                    if (c > 0x7F) {
                        builder.Append("&#");
                        builder.Append(Convert.ToString(c, 10));
                        builder.Append(';');
                    }
                    else {
                        builder.Append(c);
        ...
        public String Unescape(String/*!*/ str) {
            ...
            if (firstAmp < 0) {
                ...
                StringBuilder stringBuilder = CreateStringBuilder(str);
                try {
                    this.DoUnescape(stringBuilder, str, firstAmp);
                }
                catch (Exception e) {
        ...
        /// <summary>
        /// Unescapes the escaped entities in the <code>String</code> passed 
        /// and writes the result to the <code>Writer</code> passed.
        /// </summary>
        /// <param name="builder">The <code>Writer</code> to write the results to; assumed to be non-null.</param>
        /// <param name="str">The source <code>String</code> to unescape; assumed to be non-null.</param>
        public void Unescape(StringBuilder/*!*/ builder, String/*!*/ str) {
            int firstAmp = str.IndexOf('&');
            if (firstAmp < 0) {
                builder.Append(str);
                return;
                ...
                DoUnescape(builder, str, firstAmp);
            }
        }

        /// <summary>
        /// Make the StringBuilder 10% larger than the source String to avoid growing the writer
        /// </summary>
        /// <param name="str">The source string</param>
        /// <returns>A newly created StringWriter</returns>
        private StringBuilder CreateStringBuilder(String str) {
            return new StringBuilder((int)(str.Length + (str.Length * 0.1)));
        }

        /// <summary>
        /// Underlying unescape method that allows the optimisation of not starting from the 0 index again.
        /// </summary>
        /// <param name="builder">The <code>StringBuilder</code> to write the results to; assumed to be non-null.</param>
        /// <param name="str">The source <code>String</code> to unescape; assumed to be non-null.</param>
        /// <param name="firstAmp">The <code>int</code> index of the first ampersand in the source String.</param>
        private void DoUnescape(StringBuilder/*!*/ builder, String/*!*/ str, Int32 firstAmp) {
                            ...
                            if (entityContentLen > 1) {
                                ...
                                try {
                                    switch (isHexChar) {
                                        case 'X':
                                        case 'x':
                                            entityValue = Int32.Parse(entityContent.Substring(2), System.Globalization.NumberStyles.HexNumber);
                                            break;
                                        default:
                                            entityValue = Int32.Parse(entityContent.Substring(1), System.Globalization.NumberStyles.Integer);
                                            break;
                                    }
